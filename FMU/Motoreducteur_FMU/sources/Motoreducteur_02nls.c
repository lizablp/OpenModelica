...
void Motoreducteur_initialNonLinearSystem(int nNonLinearSystems, NONLINEAR_SYSTEM_DATA* nonLinearSystemData)
{
  ...
  nonLinearSystemData[1].analyticalJacobianColumn = Motoreducteur_functionJacNLSJac3_column;
  nonLinearSystemData[1].initialAnalyticalJacobian = Motoreducteur_initialAnalyticJacobianNLSJac3;
  ...
  nonLinearSystemData[0].analyticalJacobianColumn = Motoreducteur_functionJacNLSJac2_column;
  nonLinearSystemData[0].initialAnalyticalJacobian = Motoreducteur_initialAnalyticJacobianNLSJac2;
