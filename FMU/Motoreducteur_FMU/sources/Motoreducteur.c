...
void Motoreducteur_eqFunction_86(DATA *data, threadData_t *threadData)
{
  ...
  else
  {
    ...
    tmp7 = omc_Modelica_Math_Vectors_interpolate(threadData, tmp1, tmp4, fabs((data->localData[0]->realVars[0] /* inertia.w STATE(1,lossyGear.a_a) */)), ((modelica_integer) 1), NULL);
  }
  (data->localData[0]->realVars[17] /* lossyGear.interpolation_result[1,1] variable */) = tmp7;
  TRACE_POP
}
/*
equation index: 87
...
void Motoreducteur_eqFunction_88(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp15;
  tmp14 = (modelica_boolean)(data->localData[0]->booleanVars[0] /* lossyGear.ideal DISCRETE */);
  if(tmp14)
  {
    tmp15 = 1.0;
  }
  ...
  {
    real_array_create(&tmp8, (modelica_real*)&(data->simulationInfo->realParameter[13] /* lossyGear.lossTable[1,1] PARAM */), 2, (_index_t)1, (_index_t)5);
    create_index_spec(&tmp10, 2, (modelica_integer)(1), (int*)0, 'W', (modelica_integer)(0), make_index_array(1, (modelica_integer) ((modelica_integer) 1)), 'S');
    index_alloc_real_array(&tmp8, &tmp10, &tmp9);
    ...
    create_index_spec(&tmp13, 2, (modelica_integer)(1), (int*)0, 'W', (modelica_integer)(0), make_index_array(1, (modelica_integer) ((modelica_integer) 3)), 'S');
    index_alloc_real_array(&tmp11, &tmp13, &tmp12);
    tmp15 = omc_Modelica_Math_Vectors_interpolate(threadData, tmp9, tmp12, fabs((data->localData[0]->realVars[0] /* inertia.w STATE(1,lossyGear.a_a) */)), ((modelica_integer) 1), NULL);
  }
  (data->localData[0]->realVars[18] /* lossyGear.interpolation_result[1,2] variable */) = tmp15;
  TRACE_POP
}
/*
equation index: 89
...
void Motoreducteur_eqFunction_90(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp23;
  tmp22 = (modelica_boolean)(data->localData[0]->booleanVars[0] /* lossyGear.ideal DISCRETE */);
  if(tmp22)
  {
    tmp23 = 0.0;
  }
  ...
  {
    real_array_create(&tmp16, (modelica_real*)&(data->simulationInfo->realParameter[13] /* lossyGear.lossTable[1,1] PARAM */), 2, (_index_t)1, (_index_t)5);
    create_index_spec(&tmp18, 2, (modelica_integer)(1), (int*)0, 'W', (modelica_integer)(0), make_index_array(1, (modelica_integer) ((modelica_integer) 1)), 'S');
    index_alloc_real_array(&tmp16, &tmp18, &tmp17);
    ...
    create_index_spec(&tmp21, 2, (modelica_integer)(1), (int*)0, 'W', (modelica_integer)(0), make_index_array(1, (modelica_integer) ((modelica_integer) 4)), 'S');
    index_alloc_real_array(&tmp19, &tmp21, &tmp20);
    tmp23 = omc_Modelica_Math_Vectors_interpolate(threadData, tmp17, tmp20, fabs((data->localData[0]->realVars[0] /* inertia.w STATE(1,lossyGear.a_a) */)), ((modelica_integer) 1), NULL);
  }
  (data->localData[0]->realVars[19] /* lossyGear.interpolation_result[1,3] variable */) = tmp23;
  TRACE_POP
}
/*
equation index: 91
...
void Motoreducteur_eqFunction_92(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp31;
  tmp30 = (modelica_boolean)(data->localData[0]->booleanVars[0] /* lossyGear.ideal DISCRETE */);
  if(tmp30)
  {
    tmp31 = 0.0;
  }
  else
  {
    ...
    create_index_spec(&tmp26, 2, (modelica_integer)(1), (int*)0, 'W', (modelica_integer)(0), make_index_array(1, (modelica_integer) ((modelica_integer) 1)), 'S');
    ...
    create_index_spec(&tmp29, 2, (modelica_integer)(1), (int*)0, 'W', (modelica_integer)(0), make_index_array(1, (modelica_integer) ((modelica_integer) 5)), 'S');
    index_alloc_real_array(&tmp27, &tmp29, &tmp28);
    tmp31 = omc_Modelica_Math_Vectors_interpolate(threadData, tmp25, tmp28, fabs((data->localData[0]->realVars[0] /* inertia.w STATE(1,lossyGear.a_a) */)), ((modelica_integer) 1), NULL);
  }
  (data->localData[0]->realVars[20] /* lossyGear.interpolation_result[1,4] variable */) = tmp31;
  TRACE_POP
}
/*
equation index: 93
...
void Motoreducteur_eqFunction_94(DATA *data, threadData_t *threadData)
{
  ...
  tmp32 = LessEq(fabs((data->localData[0]->realVars[14] /* lossyGear.eta_mf1 variable */) - 1.0),1e-15);
  tmp33 = LessEq(fabs((data->localData[0]->realVars[15] /* lossyGear.eta_mf2 variable */) - 1.0),1e-15);
  (data->localData[0]->realVars[40] /* lossyGear.tau_bf_a variable */) = ((tmp32 && tmp33)?(0.5) * ((data->localData[0]->realVars[38] /* lossyGear.tau_bf1 variable */)):DIVISION_SIM((data->localData[0]->realVars[38] /* lossyGear.tau_bf1 variable */) - (data->localData[0]->realVars[39] /* lossyGear.tau_bf2 variable */),(data->localData[0]->realVars[14] /* lossyGear.eta_mf1 variable */) + DIVISION_SIM(-1.0,(data->localData[0]->realVars[15] /* lossyGear.eta_mf2 variable */),"lossyGear.eta_mf2",equationIndexes),"lossyGear.eta_mf1 + (-1.0) / lossyGear.eta_mf2",equationIndexes));
  TRACE_POP
}
/*
equation index: 95
...
void Motoreducteur_eqFunction_97(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp37;
  relationhysteresis(data, &tmp34, data->localData[0]->timeValue, (data->simulationInfo->realParameter[25] /* ramp.startTime PARAM */), 0, Less, LessZC);
  ...
  {
    relationhysteresis(data, &tmp35, data->localData[0]->timeValue, (data->simulationInfo->realParameter[25] /* ramp.startTime PARAM */) + (data->simulationInfo->realParameter[22] /* ramp.duration PARAM */), 1, Less, LessZC);
    tmp37 = (tmp35?DIVISION_SIM((data->localData[0]->timeValue - (data->simulationInfo->realParameter[25] /* ramp.startTime PARAM */)) * ((data->simulationInfo->realParameter[23] /* ramp.height PARAM */)),(data->simulationInfo->realParameter[22] /* ramp.duration PARAM */),"ramp.duration",equationIndexes):(data->simulationInfo->realParameter[23] /* ramp.height PARAM */));
  }
  (data->localData[0]->realVars[50] /* torque2.tau variable */) = (data->simulationInfo->realParameter[24] /* ramp.offset PARAM */) + tmp37;
  TRACE_POP
}
...
struct OpenModelicaGeneratedFunctionCallbacks Motoreducteur_callback = {
   ...
   Motoreducteur_initialLinearSystem,    /* initialLinearSystem */
...
void Motoreducteur_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{cb189084-b35a-4f55-abca-1faaa62d898f}";
  ...
  data->modelData->modelDataXml.nEquations = 228;
