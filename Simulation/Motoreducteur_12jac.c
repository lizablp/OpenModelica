...
void Motoreducteur_eqFunction_60(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[11] /* lossyGear.tauLossMax_p.$pDERNLSJac0.dummyVarNLSJac0 JACOBIAN_DIFF_VAR */ = (tmp0?jacobian->tmpVars[6] /* lossyGear.quadrant1_p.$pDERNLSJac0.dummyVarNLSJac0 JACOBIAN_DIFF_VAR */:jacobian->tmpVars[7] /* lossyGear.quadrant2_p.$pDERNLSJac0.dummyVarNLSJac0 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
void Motoreducteur_eqFunction_61(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  tmp1 = Greater((data->localData[0]->realVars[42] /* lossyGear.tau_eta_m variable */),0.0);
  jacobian->tmpVars[14] /* lossyGear.tauLossMin_m.$pDERNLSJac0.dummyVarNLSJac0 JACOBIAN_DIFF_VAR */ = (tmp1?jacobian->tmpVars[8] /* lossyGear.quadrant4_m.$pDERNLSJac0.dummyVarNLSJac0 JACOBIAN_DIFF_VAR */:jacobian->tmpVars[9] /* lossyGear.quadrant3_m.$pDERNLSJac0.dummyVarNLSJac0 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
void Motoreducteur_eqFunction_131(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  tmp3 = Greater((data->localData[0]->realVars[42] /* lossyGear.tau_eta_m variable */),0.0);
  jacobian->tmpVars[11] /* lossyGear.tauLossMin_m.$pDERNLSJac1.dummyVarNLSJac1 JACOBIAN_DIFF_VAR */ = (tmp3?jacobian->tmpVars[7] /* lossyGear.quadrant4_m.$pDERNLSJac1.dummyVarNLSJac1 JACOBIAN_DIFF_VAR */:jacobian->tmpVars[6] /* lossyGear.quadrant3_m.$pDERNLSJac1.dummyVarNLSJac1 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
void Motoreducteur_eqFunction_132(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  relationhysteresis(data, &tmp5, (data->localData[0]->realVars[32] /* lossyGear.sa variable */), (data->localData[0]->realVars[37] /* lossyGear.tauLossMin_m variable */), 3, Less, LessZC);
  jacobian->tmpVars[12] /* lossyGear.startBackward.$pDERNLSJac1.dummyVarNLSJac1 JACOBIAN_DIFF_VAR */ = (((data->simulationInfo->integerVarsPre[0] /* lossyGear.mode DISCRETE */) == ((modelica_integer) 0)) && tmp5);
  TRACE_POP
}
...
void Motoreducteur_eqFunction_133(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  tmp6 = Greater((data->localData[0]->realVars[43] /* lossyGear.tau_eta_p variable */),0.0);
  jacobian->tmpVars[14] /* lossyGear.tauLossMax_p.$pDERNLSJac1.dummyVarNLSJac1 JACOBIAN_DIFF_VAR */ = (tmp6?jacobian->tmpVars[9] /* lossyGear.quadrant1_p.$pDERNLSJac1.dummyVarNLSJac1 JACOBIAN_DIFF_VAR */:jacobian->tmpVars[8] /* lossyGear.quadrant2_p.$pDERNLSJac1.dummyVarNLSJac1 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
void Motoreducteur_eqFunction_134(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  relationhysteresis(data, &tmp8, (data->localData[0]->realVars[32] /* lossyGear.sa variable */), (data->localData[0]->realVars[35] /* lossyGear.tauLossMax_p variable */), 2, Greater, GreaterZC);
  jacobian->tmpVars[15] /* lossyGear.startForward.$pDERNLSJac1.dummyVarNLSJac1 JACOBIAN_DIFF_VAR */ = (((data->simulationInfo->integerVarsPre[0] /* lossyGear.mode DISCRETE */) == ((modelica_integer) 0)) && tmp8);
  TRACE_POP
}
